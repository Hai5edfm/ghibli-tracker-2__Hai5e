...
const TopMovies = () => {
  ...
  return (
    <>
      ...
      <div className="m-4 overflow-hidden overflow-x-auto bg-white rounded-md h-fit shadow-aesthetic">
        <ul className="flex flex-row w-[1600px] ">
          {myArray.length > 0 &&
            myArray.map((item: any) => (
              <li key={item.id} className="relative w-auto m-4 transition-transform cursor-pointer hover:scale-110">
                <img
